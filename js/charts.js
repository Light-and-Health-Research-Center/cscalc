...
function loadCharts(){
        ...
        yAxes: [
          ...
          },
          {
            ...
            scaleLabel: {
              display: false,
              labelString:
                "Relative Spectral Contribution of Circadian Response*",
            },
          },
        ],
        xAxes: [
  ...
  configCRM = {
    ...
    data: {
      ...
      datasets: [combinedSourceCRMDataset, crmTargetAreaDataset],
    },
    options: {
      responsive: true,
      spanGaps: true,
  ...
  // Chromaticity
  var ctxChromaticity = document
    .getElementById("chromaticityPlot")
    .getContext("2d");
    ...
    options: {
      ...
      tooltips: {
        callbacks: {
          ...
          label: function (tooltipItem, data) {
            var wavelengthStr =
              "X Coordinate: " + tooltipItem.xLabel.toFixed(2);
